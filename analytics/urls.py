...
urlpatterns = [
    ...
    path('admin/', AdminAnalyticsView.as_view(), name='admin_analytics'),   # <-- added
    path('employee/', EmployeeAnalyticsView.as_view(), name='employee_analytics'),
    path('manager/', ManagerAnalyticsView.as_view(), name='manager_analytics'),
    path('department/', DeptAnalyticsView.as_view(), name='department_analytics'),
